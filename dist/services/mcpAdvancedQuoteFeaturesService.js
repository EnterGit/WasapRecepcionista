...
export class McpAdvancedQuoteFeaturesService {
     ...
     */
    static async parseWhatsAppVoiceNote(audioUrl) {
     ...
     */
    static async backupQuoteToCloud(quote) {
     ...
     */
    static async generateBrandVariantsMockup(skus) {
     ...
     */
    static async dispatchCommercialContractEmail(customerEmail, folio, pdfUrl) {
