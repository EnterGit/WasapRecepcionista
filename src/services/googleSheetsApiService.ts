import { GoogleSheetsRow } from './googleSheetsSyncService.js';

export class GoogleSheetsApiService {
  private static SPREADSHEET_ID = 'AllSolutions_Gestion_Cotizaciones_Master';

  /**
   * Escribe una cotización en el documento oficial de Google Sheets usando Google Workspace API
   */
  public static async appendRowToGoogleSheet(rowData: GoogleSheetsRow): Promise<{ success: boolean; spreadsheetId: string; updatedRange: string }> {
