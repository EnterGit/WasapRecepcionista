...
export const handleQuoteStatusUpdate = async (req: Request, res: Response) => {
  try {
    ...
    await TvNotificationService.notifyQuoteEventOnTv(
      updatedQuote.folio,
      'Cliente All Solutions',
      updatedQuote.totalClp,
      estado,
      motivoRechazo
    );
